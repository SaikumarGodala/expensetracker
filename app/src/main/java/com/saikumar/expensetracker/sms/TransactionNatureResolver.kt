...
object TransactionNatureResolver {
    ...
    /**
     * FROZEN DECISION TREE (v1.0) - DO NOT MODIFY WITHOUT APPROVAL
     * 
     * Order of evaluation (MUST NOT CHANGE):
     * 1. Direction Detection (DEBIT/CREDIT/UNKNOWN)
     * 2. LEVEL_1: PENDING (future debits, requests, standing instructions)
     * 3. LEVEL_2: CREDIT_CARD_PAYMENT (bill payments to credit card)
     * 4. LEVEL_3: CREDIT_CARD_SPEND (purchases on credit card)
     * 5. LEVEL_4: SELF_TRANSFER (transfers between own accounts)
     * 6. LEVEL_5: INCOME (explicit or unidentified credit)
     * 7. LEVEL_6: EXPENSE (fallback for debits)
     * 
     * HARD INVARIANTS (CANNOT BE OVERRIDDEN):
     * - Debit + INCOME = FORBIDDEN (throw error in debug)
     * - CC Payment + INCOME/EXPENSE = FORBIDDEN
     * - PENDING + Saved = FORBIDDEN
     * - STOP on first match (no fallthrough)
     */
     ...
     * 
     * Keywords: "spent", "purchased", "swipe", "transaction on card"
     * Direction: Debit only (money leaves the account)
     */
     ...
     * - Source: NOT self transfer, NOT CC payment
     * - Content: Salary, interest, dividend, bonus, etc.
     */

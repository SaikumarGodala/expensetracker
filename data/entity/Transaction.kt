...
@Entity(
    ...
    indices = [
        ...
        Index(value = ["smsHash"]),
        // Phase 7 Optimization: Composite indexes for common query patterns
        Index(value = ["smsHash", "timestamp"]),  // SMS dedup + time ordering
        Index(value = ["categoryId", "timestamp"])  // Dashboard filtering + ordering
    ]
)

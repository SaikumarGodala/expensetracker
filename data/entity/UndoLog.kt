...
@Entity(
    tableName = "undo_log",
    indices = [
        Index(value = ["isUndone"]),  // Phase 7 Optimization: Fast filtering for undoable actions
        Index(value = ["isUndone", "performedAt"])  // Composite for undo retrieval with ordering
    ]
)
data class UndoLog(
